...
"""image_dataset = "C://Users/Houssem/Downloads/Dataset_BUSI_with_GT_144/image_dataset/"
mask_dataset = "C://Users/Houssem/Downloads/Dataset_BUSI_with_GT_144/label_dataset/"

images_path,annotation_path=load_data(image_data=image_dataset,data_mask=mask_dataset)
image,mask=image_preprocessing(images_path[0],annotation_path[0])
...
y_pred=u_net_segmentation(img)
print(y_pred.shape)


loss_1=focal_tversky(y_true=y_true,y_pred=y_pred)
print(loss_1)
loss_2=focal_tversky_1(y_true,y_pred)
print(loss_2)

dice_loss_1=dice(y_true,y_pred)
print(dice_loss_1)
dice_loss_2=dice_loss(y_true,y_pred)
print(dice_loss_2)

tversky_1=tversky(y_true,y_pred)
print(tversky_1)
tversky_2=tversky_loss(y_true, y_pred)
print(tversky_2)

loss_func =binary_focal_loss([0, 1, 1], [0.1, 0.7, 0.9], gamma=2)
print(tf.reduce_sum(loss_func))
f_loss=binary_focal_loss_1(tf.convert_to_tensor([0., 1., 1.]), tf.convert_to_tensor([0.1, 0.7, 0.9]))
print(f_loss)"""



"""feature_input=Input(shape=(128,128,256))
output=conv_attention_model(feature_input)
